      ...
      .get(
        ...
        },
        {
          ...
          detail: {
            ...
            description:
              'OWNER and AGENT both see AGENT and CLIENT users; the OWNER is never listed. Returns active users only. Use GET /users/mis-usuarios/clientes when only clients are wanted.',
          },
        },
      )
      .get(
